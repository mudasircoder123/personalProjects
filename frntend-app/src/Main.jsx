...
import { addToCart } from './cartSlice.jsx'; // Import the addToCart action
...
const Main = () => {
    ...
    <div className="flex justify-between gap-4"> {/* Add flex container for buttons */}
        <button
            onClick={() => handleAddToCart(product)} // Call addToCart on button click
            className="w-full md:w-auto flex justify-between items-center font-bold cursor-pointer hover:underline text-gray-800 dark:text-gray-50"
        >
            <span className="text-base">Add to Cart</span>
        </button>
        
     {/* Link to Checkout with product details */}
     <Link   to={{pathname: "/checkout",state: { product }  // Pass product data to Checkout 
     }}>
