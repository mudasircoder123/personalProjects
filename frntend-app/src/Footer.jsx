      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mb-4">
              <img className="h-10" src="logo.png" alt="Company Logo" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-400 hover:text-sky-500 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/collections" className="text-gray-400 hover:text-sky-500 transition-colors">
                  Collections
                </Link>
              </li>
              <li>
                <Link to="/orders" className="text-gray-400 hover:text-sky-500 transition-colors">
                  My Orders
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-sky-500 transition-colors">
                  About Us
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              <button
                type="submit"
                className="bg-sky-500 hover:bg-sky-700 transition-colors text-white px-4 py-2 rounded whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
